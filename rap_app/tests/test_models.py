...
class PartenaireTestCase(TestCase):
    ...
    def test_partenaire_creation(self):
        """Test de création d'une partenaire"""
        self.assertEqual(self.partenaire.nom, "Partenaire Test")
        self.assertEqual(self.partenaire.secteur_activite, "IT")
        self.assertEqual(self.partenaire.contact_nom, "Jean Dupont")
        self.assertEqual(self.partenaire.contact_email, "jean@example.com")

    def test_partenaire_str(self):
        """Test de la méthode __str__"""
...
class FormationTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.partenaire = Partenaire.objects.create(nom="Partenaire Test")
        ...
        # Ajouter une partenaire à la formation
    ...
    def test_formation_creation(self):
        ...
        self.assertEqual(self.formation.partenaires.count(), 1)
